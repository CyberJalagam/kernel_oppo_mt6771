...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_for_18611[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
#ifdef VENDOR_EDIT
/*Xi.Chen@RM.Camera 20190307 add for power sequence*/
...
#endif
#ifdef VENDOR_EDIT
/*Xiaoyang.Huang@RM.Camera add for s5k3l6 and imx576,20190202*/

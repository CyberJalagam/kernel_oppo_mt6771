...
** VENDOR_EDIT
** File: - oppo18611_dsjm_himax83112a_1080p_dsi_vdo.c
** Description: Source file for lcd drvier.
** lcd driver including parameter and power control.
** Version: 1.0
** Date : 2018/08/24
** Author: Shizeke@PSW.MultiMedia.Display.LCD.Machine
**
** ------------------------------- Revision History:---------------
** Shizeke 2018/8/24 1.0 build this module
*******************************************************************/
...
//Zeke.Shi@RM.MM.Display.Machine, 2019/01/08, Add for 3level cabc feature.
...
static void lcm_init(void)
{
	...
	switch (cabc_lastlevel) {
        case 2 :
            push_table(lcm_cabc_enter_setting_image, sizeof(lcm_cabc_enter_setting_image) / sizeof(struct LCM_setting_table), 1);
            break;
        case 3 :
            push_table(lcm_cabc_enter_setting_video, sizeof(lcm_cabc_enter_setting_video) / sizeof(struct LCM_setting_table), 1);
            break;
        default :
            LCD_DEBUG("[lcd] default cabc level is 1, don't need to set\n");
            break;
    }
...
static void lcm_set_cabc_mode_cmdq(void *handle, unsigned int level)
{
	...
	switch (level) {
        case 1 :
            push_table22(handle,lcm_cabc_enter_setting_ui, sizeof(lcm_cabc_enter_setting_ui) / sizeof(struct LCM_setting_table), 1);
            break;
        case 2 :
            push_table22(handle,lcm_cabc_enter_setting_image, sizeof(lcm_cabc_enter_setting_image) / sizeof(struct LCM_setting_table), 1);
            break;
        case 3 :
            push_table22(handle,lcm_cabc_enter_setting_video, sizeof(lcm_cabc_enter_setting_video) / sizeof(struct LCM_setting_table), 1);
            break;
        default :
            push_table22(handle,lcm_cabc_exit_setting, sizeof(lcm_cabc_exit_setting) / sizeof(struct LCM_setting_table), 1);
            break;
...
#endif
LCM_DRIVER oppo18611_dsjm_himax83112a_1080p_dsi_vdo_lcm_drv=
{
	.name = "oppo18611_dsjm_himax83112a_1080p_dsi_vdo",
